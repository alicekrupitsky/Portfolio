  ...
  const timelineEvents: TimelineEvent[] = [
    {
      ...
      bullets: [
        "Develop end-to-end Python ETL pipelines that ingest, transform, validate, and load multi-source data into BeachLens’ production database.",
        "Build data-quality workflows that detect inconsistencies, reconcile duplicate records, and standardize datasets before they reach production.",
      ],
    },
    {
      id: "solv",
